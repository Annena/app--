define('page/shopChoice', [
    ...
    // 商家点餐之后选择门店列表页面
    ShopChoice.prototype = new Page('shopChoice');
        ...
        var ShopChoicePage = {
            ...
            displayData: function(data, type) {
                ...
                for (var i in data) {
                    ...
                    content += '<div class="shoplist-list-floor" data-type="shopChoice" shop-id="' + data[i].shop_id + '" shop-name="' + data[i].shop_name + '">' +
            ...
            shopChoiceBind: function() {
                ...
                $('#shopListMain').delegate('div[data-type="shopChoice"]', 'click', function() {
                    ...
                    if (type == 'tel') {
                        ...
                        ////alert('ttt');
                        Page.open('dishes&card_id=' + cardId + '&shop_id=' + shopId + '&shop_name=' + shopName + '&page=shopChoice&order_property=1');
                    }
                });
